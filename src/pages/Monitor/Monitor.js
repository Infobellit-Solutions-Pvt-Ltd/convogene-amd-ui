...
//       .get("http://192.168.1.81:5000/data")
...
//     axios
//       // .get(
//       //   "https://streamlit-test.thankfulriver-bb957f46.koreacentral.azurecontainerapps.io/analytics"
//       // )
//       .get("http:///192.168.1.81:5000/analytics")
...
//   const modified_tableData = tableData.map(
//     ({ Input, Output, ...rest }) => rest
//   );
  ...
  return (
    ...
    >
      ...
      <Grid item xs={12} md={2.4}>
        <Card style={{ height: "100%" }}>
          <CardContent>
            <Typography variant="h6">Average TTFT per Question</Typography>
            <Typography variant="h4">
              {averageLatencyPerQuestion.toFixed(2)} ms
            </Typography>
          </CardContent>
